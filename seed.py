...
def seed_fs_data():
    ...
    model.Region.__table__.create(model.db.engine)
    model.Forest.__table__.create(model.db.engine)
    model.District.__table__.create(model.db.engine)
    model.Trail.__table__.create(model.db.engine)
